...
func (c *interactiveRepository) GetByIds(ctx context.Context, biz string, ids []int64) ([]domain.Interactive, error) {
...
func (c *interactiveRepository) Liked(ctx context.Context, biz string, id int64, uid int64) (bool, error) {
...
func (c *interactiveRepository) Collected(ctx context.Context, biz string, id int64, uid int64) (bool, error) {
...
func (c *interactiveRepository) IncrLike(ctx context.Context,
...
func (c *interactiveRepository) DecrLike(ctx context.Context,
	biz string, bizId int64, uid int64) error {
...
func (c *interactiveRepository) IncrReadCnt(ctx context.Context,
	biz string, bizId int64) error {
...
func (c *interactiveRepository) BatchIncrReadCnt(ctx context.Context,
	bizs []string, bizIds []int64) error {
	return c.dao.BatchIncrReadCnt(ctx, bizs, bizIds)
}

func (c *interactiveRepository) AddCollectionItem(ctx context.Context,
...
func (c *interactiveRepository) Get(ctx context.Context,
